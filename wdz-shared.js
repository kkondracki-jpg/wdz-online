...
var WDZ_FIREBASE_CONFIG = {
  apiKey:"AIzaSyAdijHjmWcGRJB4kxiP1w0Y92YZ0b-1_Mg",
  authDomain:"wdz-online.firebaseapp.com",
  databaseURL:"https://wdz-online-default-rtdb.firebaseio.com",
  projectId:"wdz-online",
  storageBucket:"wdz-online.appspot.com",
  messagingSenderId:"1095995830516",
  appId:"1:1095995830516:web:4e43e3a8d7c0e7afdb9d8c"
};
...
// ── Scoring ──
function calcScore(fId, fd, bf, bnbEnabled, mapEnabled) {
  ...
  var mapScore = mapEnabled ? (uniqueFrags.length >= 4 ? 10 : uniqueFrags.length * 2) : 0;
